...
export default function InfiniteScroll() {
    ...
    const infiniteFetchData = () => {
        ...
        fetch(`https://api.unsplash.com/search/photos?page=${pageIndex}&per_page=30&query=${searchState}&client_id=z94MccUbuKLkQtEgzMbJTF9Qs5oCHgr08X7lXtaPu98`).then((response) => {
    ...
    return (
        <div className="container">
            <form onSubmit={handleSearch}>
                ...
                <label htmlFor="search">Choisissez votre thème :</label>
